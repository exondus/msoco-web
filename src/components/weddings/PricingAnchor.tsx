...
export default function PricingAnchor({ startingPrice, premiumPrice }: PricingAnchorProps) {
  return (
    <section className="py-24 bg-white border-y border-gray-100 px-8 text-center">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <h2 className="font-playfair text-5xl md:text-6xl text-wedding-charcoal tracking-tighter">
          Weddings starting from{' '}
          <span className="text-wedding-gold">{startingPrice}</span>.
        </h2>
        <p className="font-montserrat text-sm text-wedding-charcoal/50 leading-loose uppercase tracking-widest">
          Custom cinematic productions from {premiumPrice}+. Every package includes full-day coverage, 4K video, and a curated gallery.
        </p>
        <a
          href="#contact"
