        ...
        <main className="flex-1">
              ...
              >
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-20">
                  <div className="max-w-4xl">
                    <span className="inline-block px-4 py-1.5 border border-wedding-gold/30 text-wedding-gold text-[10px] font-black uppercase tracking-[0.5em] mb-10">
                      Portfolio
                    </span>
                    <h1 className="text-7xl md:text-[10rem] font-playfair font-light uppercase tracking-tighter leading-[0.8] text-wedding-charcoal">
                      Our <br />
                      <span className="italic">Artistry.</span>
                    </h1>
                  </div>
                  <div className="max-w-sm">
                    <p className="text-lg text-wedding-charcoal/60 font-playfair italic font-light leading-relaxed mb-8">
          ...
          <section className="pb-40 px-8">
            <div className="max-w-[1600px] mx-auto">
              ...
              >
                <div className="inline-block px-8 py-4 border border-wedding-gold/10">
                  <p className="font-montserrat text-[9px] uppercase tracking-[0.4em] text-wedding-charcoal/40">
                    21 carefully curated wedding portraits &bull; Durban, KZN
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-16 mb-12">
              ...
              <div className="grid grid-cols-2 gap-12 text-sm">
                ...
                <div className="space-y-4">
                  ...
                  <p className="font-montserrat text-wedding-charcoal/70">+${CONTACT_NUMBER}</p>
